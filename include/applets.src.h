 ...
 * NDSCTL
 */
IF_NDSCTL(APPLET(ndsctl, BB_DIR_BIN, BB_SUID_DROP))
IF_NETSTAT(APPLET(netstat, BB_DIR_BIN, BB_SUID_DROP))
IF_NICE(APPLET(nice, BB_DIR_BIN, BB_SUID_DROP))
/*
 * NODOGSPLASH
 */
IF_NODOGSPLASH(APPLET(nodogsplash, BB_DIR_BIN, BB_SUID_DROP))
 ...
 * PHDDNS
 */
IF_PHDDNS(APPLET(phddns, BB_DIR_SBIN, BB_SUID_DROP))
