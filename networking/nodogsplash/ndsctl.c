...
//usage:#define ndsctl_trivial_usage
//usage:       "Usage: ndsctl [options] command [arguments]\n"
//usage:       "\n"
//usage:       "options:\n"
//usage:       "  -s <path>         Path to the socket\n"
//usage:       "  -h                Print usage\n"
//usage:       "\n"
//usage:       "commands:\n"
//usage:       "  status            View the status of nodogsplash\n"
//usage:       "  clients           Display machine-readable client list\n"
//usage:       "  stop              Stop the running nodogsplash\n"
//usage:       "  auth ip           Authenticate user with specified ip\n"
//usage:       "  deauth mac|ip     Deauthenticate user with specified mac or ip\n"
//usage:       "  block mac         Block the given MAC address\n"
//usage:       "  unblock mac       Unblock the given MAC address\n"
//usage:       "  allow mac         Allow the given MAC address\n"
//usage:       "  unallow mac       Unallow the given MAC address\n"
//usage:       "  trust mac         Trust the given MAC address\n"
//usage:       "  untrust mac       Untrust the given MAC address\n"
//usage:       "  loglevel n        Set logging level to n\n"
//usage:       "  password pass     Set gateway password\n"
//usage:       "  username name     Set gateway username\n"
//usage:#define ndsctl_full_usage "\n\n"
//usage:       "Usage: ndsctl [options] command [arguments]\n"
//usage:       "\n"
//usage:       "options:\n"
//usage:       "  -s <path>         Path to the socket\n"
...
int ndsctl_main(int argc, char **argv[]) MAIN_EXTERNALLY_VISIBLE;

int
ndsctl_main(int argc, char **argv[])
{
	/* Init configuration */
	init_config();
