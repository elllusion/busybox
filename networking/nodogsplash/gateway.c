...
//usage:#define nodogsplash_trivial_usage
//usage:       "Usage: nodogsplash [options]\n"
//usage:       "\n"
//usage:       "  -c [filename] Use this config file\n"
//usage:       "  -f            Run in foreground\n"
//usage:       "  -d <level>    Debug level\n"
//usage:       "  -s            Log to syslog\n"
//usage:       "  -w <path>     Ndsctl socket path\n"
//usage:       "  -h            Print usage\n"
//usage:       "  -v            Print version information\n"
//usage:       "\n"
//usage:#define nodogsplash_full_usage "\n\n"
//usage:       "Usage: nodogsplash [options]\n"
//usage:       "\n"
//usage:       "  -c [filename] Use this config file\n"
//usage:       "  -f            Run in foreground\n"
 ...
 */
int nodogsplash_main(int argc, char **argv[]) MAIN_EXTERNALLY_VISIBLE;

int nodogsplash_main(int argc, char **argv[])
{
	...
	nodogsplash_config_read(config->configfile);
	config_validate();
